class script(object):  
    START_TXT = """<blockquote>Hᴇʟʟᴏ 👋🏻 {}, ᴍʏ ɴᴀᴍᴇ <a href=https://t.me/{}>{}</blockquote>
...
I Cᴀɴ Pʀᴏᴠɪᴅᴇ Mᴏᴠɪᴇ Fᴏʀ Yᴏᴜ Jᴜsᴛ Aᴅᴅ Mᴇ Iɴ Yᴏᴜʀ Gʀᴏᴜᴘ Oʀ Jᴏɪɴ Oᴜʀ Gʀᴏᴜᴘ"""
    ...
    ABOUT_TXT = """<b>✯ Mʏ ɴᴀᴍᴇ: {}
✯ Dᴇᴠᴇʟᴏᴩᴇʀ: <a herf=https://t.me/i_hackerdoc>ᴀɴᴏɴʏᴍᴏᴜꜱ</a>
...
<b>⪼ EG:</b>
</code>/batch https://t.me/dochacks/1 https://t.me/dochacks/10</code>"""
