...
PICS = (environ.get('PICS' ,'https://envs.sh/BZy.jpg https://envs.sh/BZ6.jpg https://envs.sh/BZV.jpg https://envs.sh/BZx.jpg https://envs.sh/BLD.jpg https://envs.sh/BZ-.jpg')).split()
UPTIME = time.time()
...
# MongoDB information
DATABASE_URL = environ.get('DATABASE_URL', "mongodb+srv://freeuser26:user2002@cluster0.dxfzs.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MH_chitchat')
